...
function venedor_portfolio_init() {
    ...
    register_post_type(         
        'portfolio',
        array(
            'labels' => venedor_labels('Portfolio', 'Portfolios'),
    ...
    register_taxonomy(
        ...
        array(
            'hierarchical' => true, 
            'labels' => venedor_labels_tax('Portfolio Category', 'Portfolio Categories'),
            'query_var' => true, 
            'rewrite' => true
        )
    );
    ...
    register_taxonomy(
        ...
        array(
            'hierarchical' => true, 
            'labels' => venedor_labels_tax('Portfolio Skill', 'Portfolio Skills'),
            'query_var' => true, 
            'rewrite' => true
        )
    );
