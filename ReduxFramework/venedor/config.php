...
.wpb_toggle_title_active:before {
    <?php venedor_print_shover_border('btn') ?>
...
.progress-bar:before {
    border-left-color: <?php echo $c['btn-hbg-color'] ?>;
    border-left-color: <?php echo venedor_print_rgb($c['btn-sbg-color'], -20) ?>;
}
.progress-bar:after {
    border-top-color: <?php echo $c['btn-sbg-color'] ?>;
    border-right-color: <?php echo $c['btn-sbg-color'] ?>;
}
...
/*#mini-cart .dropdown-menu {
    border-color: <?php echo $c['mini-cart-hbg-color'] ?>;
}*/
...
<?php if ($c['menu-link-bg-color'] == 'transparent' && $c['menu-link-hover-bg-color'] == 'transparent') : ?>
.mega-menu > ul > li > a,
.mega-menu > ul > li > h5 {
    padding-left: 0;
    padding-right: 50px;
...
.testimonial .testimonial-details:after {
    background: url(<?php echo $c['testimonial-arrow']['url'] ?>) no-repeat center center;
}
...
.widget_brand_nav.widget_layered_nav .slimScrollDiv > *:first-child .arrow:hover, .widget_product_categories .slimScrollDiv > *:first-child .arrow:focus {
...
.widget_brand_nav.widget_layered_nav .slimScrollDiv > *:first-child .arrow:before {
    content: "\f107";
}
...
.widget_brand_nav.widget_layered_nav .slimScrollDiv > *:first-child .open .arrow:before {
    content: "\f106";
}
