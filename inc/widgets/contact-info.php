...
class Venedor_Contact_Info_Widget extends WP_Widget {
	...
	function Venedor_Contact_Info_Widget() {
		...
		$this->WP_Widget('contact-info-widget', __('Venedor: Contact Info', 'venedor'), $widget_ops, $control_ops);
	}
        ...
        foreach ($this->params as $key => $value) :
            if ($instance[$key]) : 
                switch ($key) { 
                    ...
                    case 'skype':
                    ?>
                        <p class="<?php echo $key ?>"><?php echo $value ?>: <?php echo $instance[$key]; ?></p>
                    <?php
                        break;
                    case 'title':
                    case 'email-address':
                    ...
                    case 'email':
                    ?>
                        <p class="<?php echo $key ?>"><?php echo $value ?>: <a href="mailto:<?php echo $instance['email-address']; ?>"><?php if($instance[$key]) { echo $instance[$key]; } else { echo $instance[$key]; } ?></a></p>
                    <?php 
                        break;
                    case 'website':
                    ?>
                        <p class="<?php echo $key ?>"><?php echo $value ?> <a href="<?php echo $instance['website-url']; ?>"><?php if($instance[$key]) { echo $instance[$key]; } else { echo $instance[$key]; } ?></a></p>
                    <?php 
                        break;
                    default: ?>
                        <p class="<?php echo $key ?>"><?php echo $instance[$key]; ?></p>
            <?php }
            endif;
        endforeach; ?>
		</div>
