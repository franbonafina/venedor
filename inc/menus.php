...
class Walker_Nav_Menu_Edit_Custom extends Walker_Nav_Menu  {
    ...
    <div class="edit-menu-item-popup-<?php echo $item_id; ?>" style="<?php if ($depth == 0) echo 'display:block;'; else echo 'display:none;' ?>">
        ...
        <p class="description description-wide">
            <label for="edit-menu-item-popup_stype-<?php echo $item_id; ?>">
                <?php echo 'Popup Styles (only wide)'; ?><br />
                <textarea id="edit-menu-item-popup_stype-<?php echo $item_id; ?>" class="widefat edit-menu-item-popup_stype" rows="3" cols="20"
