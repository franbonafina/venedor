    ...
    **/
    ...
    ?>
        ...
        <?php else : ?>
            ...
            <p class="shortcode shortcode-products <?php echo $class ?> <?php if ($animation_type) echo 'animated' ?>"
                <?php if ($animation_type) : ?>
               animation_type="<?php echo $animation_type ?>" animation_duration="<?php echo $animation_duration ?>" animation_delay="<?php echo $animation_delay ?>"
                <?php endif; ?>><?php _e( 'No products were found matching your selection.', 'woocommerce' ); ?></p>
    ...
    **/
    ...
    ?>
        ...
        if ( $products->have_posts() ) : ?>
            ...
            <div class="shortcode shortcode-products sales products<?php if ($view == 'slider') echo ' product-slider'; else echo ($venedor_settings['category-calc-height']) ? ' grid calc-height' : ' grid'; ?><?php if (!$title) echo ' notitle'; ?><?php if ($desc) echo ' with-desc'; ?><?php if ($single == 'true') echo ' single'; ?> <?php echo $class ?> <?php if ($animation_type) echo 'animated' ?>"
                <?php if ($animation_type) : ?>
                 animation_type="<?php echo $animation_type ?>" animation_duration="<?php echo $animation_duration ?>" animation_delay="<?php echo $animation_delay ?>"
                <?php endif; ?>>
    ...
    **/
    ...
    ?>
        ...
        if ( $products->have_posts() ) : ?>
            ...
            <div class="shortcode shortcode-products latests products<?php if ($view == 'slider') echo ' product-slider'; else echo ($venedor_settings['category-calc-height']) ? ' grid calc-height' : ' grid'; ?><?php if (!$title) echo ' notitle'; ?><?php if ($desc) echo ' with-desc'; ?><?php if ($single == 'true') echo ' single'; ?> <?php echo $class ?> <?php if ($animation_type) echo 'animated' ?>"
                <?php if ($animation_type) : ?>
                 animation_type="<?php echo $animation_type ?>" animation_duration="<?php echo $animation_duration ?>" animation_delay="<?php echo $animation_delay ?>"
                <?php endif; ?>>
