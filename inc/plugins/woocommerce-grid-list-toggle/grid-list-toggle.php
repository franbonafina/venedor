...
if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
	 ...
	 * Localisation
	 **/
	load_plugin_textdomain( 'wc_list_grid_toggle', false, sys_theme_plugins.'/woocommerce-grid-list-toggle/languages/' );
	...
	if (!class_exists('WC_List_Grid')) {
		...
		class WC_List_Grid {
			...
			function setup_scripts_styles() {
				if ( is_shop() || is_product_category() || is_product_tag() || is_product_taxonomy() ) {
					//wp_enqueue_style( 'grid-list-layout', sys_theme_plugins_uri.'/woocommerce-grid-list-toggle/assets/css/style.css' );
					//wp_enqueue_style( 'grid-list-button', sys_theme_plugins_uri.'/woocommerce-grid-list-toggle/assets/css/button.css' );
				}
			}
			function setup_scripts_script() {
				if ( is_shop() || is_product_category() || is_product_tag() || is_product_taxonomy() ) {
					wp_enqueue_script( 'cookie', sys_theme_plugins_uri.'/woocommerce-grid-list-toggle/assets/js/jquery.cookie.min.js', array( 'jquery' ) );
					wp_enqueue_script( 'grid-list-scripts', sys_theme_plugins_uri.'/woocommerce-grid-list-toggle/assets/js/jquery.gridlistview.min.js', array( 'jquery' ) );
