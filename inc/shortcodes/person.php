...
function venedor_shortcode_persons($atts, $content = null) {
    ...
    <div id="persons-<?php echo $venedor_persons_id ?>-start" class="shortcode shortcode-persons <?php echo $class ?> <?php if ($animation_type) echo 'animated' ?>"
        ...
        <?php endif; ?>
        <div id="persons-<?php echo $venedor_persons_id ?>" class="content-slider owl-carousel single<?php if (!$title) echo ' notitle' ?> clearfix">
...
function venedor_shortcode_person($atts, $content = null) {
    ...
    <div class="shortcode person content-item <?php echo $class ?> <?php if ($animation_type) echo 'animated' ?>"
        ...
        <div class="row">
            <?php if ($photo) : ?>
            <div class="person-photo col-sm-4"><img class="img-responsive" src="<?php echo $photo ?>"/></div>
            <?php endif; ?>
...
function venedor_shortcode_person_box($atts, $content = null) {
    ...
    ob_start();
    ?>
    <div class="shortcode person-box person content-item col-sm-<?php echo 12 / $venedor_person_box_cols ?> col-xs-6 <?php echo $class ?> <?php if ($animation_type) echo 'animated' ?>"
        <?php if ($animation_type) : ?>
         animation_type="<?php echo $animation_type ?>" animation_duration="<?php echo $animation_duration ?>" animation_delay="<?php echo $animation_delay ?>"
        <?php endif; ?><?php if ($venedor_person_box_i % $venedor_person_box_cols == 0) echo ' style="clear:both;"' ?>>
        <?php if ($photo) : ?>
        <div class="person-photo"><img class="img-responsive" src="<?php echo $photo ?>"/></div>
        <?php endif; ?>
...
<div class="shortcode persons-slider <?php echo $class ?> <?php if ($animation_type) echo 'animated' ?>"
    <?php if ($animation_type) : ?>
     animation_type="<?php echo $animation_type ?>" animation_duration="<?php echo $animation_duration ?>" animation_delay="<?php echo $animation_delay ?>"
    <?php endif; ?>><div class="product-slider">
    <?php if ($title) : ?>
...
function venedor_shortcode_persons_slide($atts, $content = null) {
    ...
    ob_start();
    ?>
<div class="shortcode person-box person post-item <?php echo $class ?> <?php if ($animation_type) echo 'animated' ?>"
    <?php if ($animation_type) : ?>
     animation_type="<?php echo $animation_type ?>" animation_duration="<?php echo $animation_duration ?>" animation_delay="<?php echo $animation_delay ?>"
    <?php endif; ?>>
    <?php if ($photo) : ?>
