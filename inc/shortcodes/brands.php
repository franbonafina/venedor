...
function venedor_shortcode_brands($atts, $content = null) {
    ...
    <div class="shortcode shortcode-brands <?php echo $class ?> <?php if ($animation_type) echo 'animated' ?>"
        ...
        <?php endif; ?>
        <?php echo ($single_item=='true'?'':'<div class="row">') ?><div id="brands-<?php echo $venedor_brands_id ?>" class="content-slider owl-carousel <?php echo ($single_item=='true'?'single':'') ?><?php if (!$title) echo ' notitle' ?> clearfix">
