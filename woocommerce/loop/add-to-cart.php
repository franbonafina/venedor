...
<div class="add-links-wrap">
	...
	sprintf( '<a href="%s" rel="nofollow" data-product_id="%s" data-product_sku="%s" class="button cart-links %s product_type_%s">%s</a>',
		esc_url( $product->add_to_cart_url() ),
		esc_attr( $product->id ),
		esc_attr( $product->get_sku() ),
		($product->is_purchasable() && $product->is_in_stock() && $handler != 'variable' && $handler != 'grouped' && $handler != 'external') ? 'add_to_cart_button' : '',
