...
<?php endif; ?>
		...
		<form method="post" class="login">
			...
			<p class="form-row button-row">
				...
				<input type="submit" class="button btn-lg" name="login" value="<?php _e( 'Login', 'woocommerce' ); ?>" />
		...
		<form method="post" class="register">
			...
			<?php if ( 'no' === get_option( 'woocommerce_registration_generate_username' ) ) : ?>
				...
				<p class="form-row form-row-first input-field">
					...
					<input type="text" class="input-text" name="username" id="reg_username" value="<?php if (isset($_POST['username'])) echo esc_attr($_POST['username']); ?>" placeholder="<?php _e( 'Username', 'woocommerce' ); ?>" />
				</p>
			...
			<p class="form-row form-row-last input-field">
				...
				<input type="email" class="input-text" name="email" id="reg_email" value="<?php if (isset($_POST['email'])) echo esc_attr($_POST['email']); ?>" placeholder="<?php _e( 'Email', 'woocommerce' ); ?>" />
			</p>
			...
			<p class="form-row button-row">
				...
				<input type="submit" class="button btn-lg" name="register" value="<?php _e( 'Register', 'woocommerce' ); ?>" />
			</p>
