...
class Venedor_Flickr_Widget extends WP_Widget {
	...
	function Venedor_Flickr_Widget() {
		...
		$this->WP_Widget('flickr-widget', __('Venedor: Flickr', 'venedor'), $widget_ops, $control_ops);
	}
	...
	function widget($args, $instance) {
        ...
        if ( ( ($user_id && $number1) || ($photoset_id && $number2) ) && $api ) {
            ...
            <?php if ($user_id && $number1) : ?>
                <script type="text/javascript" src="http://api.flickr.com/services/rest/?format=json&amp;method=flickr.photos.search&amp;user_id=<?php echo $user_id; ?>&amp;api_key=<?php echo $api; ?>&amp;media=photos&amp;per_page=<?php echo $number1; ?>&amp;privacy_filter=1"></script>
            <?php endif; ?>
            <?php if ($photoset_id && $number2) : ?>
                <script type="text/javascript" src="http://api.flickr.com/services/rest/?format=json&amp;method=flickr.photosets.getPhotos&amp;photoset_id=<?php echo $photoset_id; ?>&amp;api_key=<?php echo $api; ?>&amp;media=photos&amp;per_page=<?php echo $number2; ?>&amp;privacy_filter=1"></script>
            <?php endif; ?>
            <?php 
            echo $after_widget;
        }
