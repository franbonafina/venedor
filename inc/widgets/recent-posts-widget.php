...
class Recent_Posts_Widget extends WP_Widget {
    ...
    {
        $defaults = array('title' => __('Recent Posts', 'venedor'), 'number' => 6, 'items' => 1, 'show_title' => 'on', 'show_excert' => 'on', 'show_meta' => 'on');
    ...
    function shortcode($atts, $content) {
        ...
        if ($posts->have_posts()) :
            ...
            ob_start();
            if ($count) : ?>
            <div class="entry-related related-slider <?php echo $class ?><?php if (!$title) echo ' notitle' ?><?php if ($desc) echo ' with-desc'; ?> <?php if ($animation_type) echo 'animated' ?>"
