...
<div class="pager">
    ...
    <nav class="woocommerce-pagination">
        <?php
            ...
            echo preg_replace('~>\s+<~m', '><', $pager_links);
        ?>
    </nav>
    <?php endif; ?>
    <?php // view limiter ?>
            ...
            <ul class="dropdown-menu">
                ...
                for ($i = 0; $i < count($per_page); $i++) :
                    if ($item_count != $per_page[$i]) : ?>
                        <li><a tabindex="-1" href="<?php echo venedor_add_url_parameters($query_string, 'product_count', $per_page[$i]) ?>"><?php echo $per_page[$i] ?></a></li>
                <?php endif; 
                endfor; ?>
            </ul>
        </div>
