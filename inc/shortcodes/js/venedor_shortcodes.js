...
jQuery(function($) {
    ...
    var form = jQuery('<div id="background-form"><table id="background-table" class="form-table">\
            ...
            <tr>\
				...
				<td><input type="text" name="padding" id="background-padding" value="30px" /></td>\
			</tr>\
			<tr>\
...
jQuery(function($) {
    ...
    var form = jQuery('<div id="recent_posts-form"><table id="recent_posts-table" class="form-table">\
			...
			<tr>\
				<th><label for="recent_posts-show_excert">Show Post Excert</label></th>\
				<td><select name="show_excert" id="recent_posts-show_excert">\
                ' + venedor_shortcode_boolean_true() + '\
				</select></td>\
			</tr>\
			<tr>\
...
jQuery(function($) {
    ...
    var form = jQuery('<div id="posts_slider-form"><table id="posts_slider-table" class="form-table">\
			...
			<tr>\
				<th><label for="posts_slider-show_excert">Show Post Excert</label></th>\
				<td><select name="show_excert" id="posts_slider-show_excert">\
                ' + venedor_shortcode_boolean_true() + '\
				</select></td>\
			</tr>\
			<tr>\
