...
if ( !isset( $venedor_options ) && file_exists( dirname( __FILE__ ) . '/ReduxFramework/venedor/functions.php' ) ) {
...
if ( !isset( $venedor_options ) && file_exists( dirname( __FILE__ ) . '/ReduxFramework/venedor/import.php' ) ) {
...
if ( !isset( $venedor_options ) && file_exists( dirname( __FILE__ ) . '/ReduxFramework/venedor/settings'.VENEDOR_SETTINGS.'.php' ) ) {
    require_once( dirname( __FILE__ ) . '/ReduxFramework/venedor/settings'.VENEDOR_SETTINGS.'.php' );
}

// Venedor Design Options
if ( !isset( $venedor_options ) && file_exists( dirname( __FILE__ ) . '/ReduxFramework/venedor/design'.VENEDOR_DESIGN.'.php' ) ) {
    ...
    if (is_404()) {
        ...
        if (function_exists('is_shop') && is_shop())  {
            if ($default)
                ...
                $layout = get_post_meta(woocommerce_get_page_id( 'shop' ), 'layout', true);
        } else {
    ...
    if (is_404()) {
        ...
        if (function_exists('is_shop') && is_shop())  {
            if ($default)
                ...
                $sidebar = get_post_meta(woocommerce_get_page_id( 'shop' ), 'sidebar', true);
        } else {
            $term = get_term_by( 'slug', get_query_var( 'term' ), get_query_var( 'taxonomy' ) );
            if ($term) {
                if ($default) {
...
function venedor_meta_bg_slider() {
    ...
    if (is_category()) {
        ...
        if (function_exists('is_shop') && is_shop())  {
            $bg_rev_slider = get_post_meta(woocommerce_get_page_id( 'shop' ), 'bg_rev_slider', true);
        } else {
            $term = get_term_by( 'slug', get_query_var( 'term' ), get_query_var( 'taxonomy' ) );
            if ($term) {
...
function venedor_meta_banner_type() {
    ...
    if (is_category()) {
        ...
        if (function_exists('is_shop') && is_shop())  {
            $banner_type = get_post_meta(woocommerce_get_page_id( 'shop' ), 'banner_type', true);
        } else {
            $term = get_term_by( 'slug', get_query_var( 'term' ), get_query_var( 'taxonomy' ) );
            if ($term) {
...
function venedor_meta_banner_width() {
    ...
    if (is_category()) {
        ...
        if (function_exists('is_shop') && is_shop())  {
            $banner_width = get_post_meta(woocommerce_get_page_id( 'shop' ), 'banner_width', true);
        } else {
            $term = get_term_by( 'slug', get_query_var( 'term' ), get_query_var( 'taxonomy' ) );
            if ($term) {
...
function venedor_meta_layer_slider() {
    ...
    if (is_category()) {
        ...
        if (function_exists('is_shop') && is_shop())  {
            $layer_slider = get_post_meta(woocommerce_get_page_id( 'shop' ), 'layer_slider', true);
        } else {
            $term = get_term_by( 'slug', get_query_var( 'term' ), get_query_var( 'taxonomy' ) );
            if ($term) {
...
function venedor_meta_rev_slider() {
    ...
    if (is_category()) {
        ...
        if (function_exists('is_shop') && is_shop())  {
            $rev_slider = get_post_meta(woocommerce_get_page_id( 'shop' ), 'rev_slider', true);
        } else {
            $term = get_term_by( 'slug', get_query_var( 'term' ), get_query_var( 'taxonomy' ) );
            if ($term) {
...
function venedor_meta_banner() {
    ...
    if (is_category()) {
        ...
        if (function_exists('is_shop') && is_shop())  {
            $banner = get_post_meta(woocommerce_get_page_id( 'shop' ), 'banner', true);
        } else {
            $term = get_term_by( 'slug', get_query_var( 'term' ), get_query_var( 'taxonomy' ) );
            if ($term) {
...
function venedor_meta_product_slider() {
    ...
    if (is_category()) {
        ...
        if (function_exists('is_shop') && is_shop())  {
            $product_slider = get_post_meta(woocommerce_get_page_id( 'shop' ), 'product_slider', true);
        } else {
            $term = get_term_by( 'slug', get_query_var( 'term' ), get_query_var( 'taxonomy' ) );
            if ($term) {
...
function venedor_meta_content_top() {
    ...
    if (is_category()) {
        ...
        if (function_exists('is_shop') && is_shop())  {
            $content_top = get_post_meta(woocommerce_get_page_id( 'shop' ), 'content_top', true);
        } else {
            $term = get_term_by( 'slug', get_query_var( 'term' ), get_query_var( 'taxonomy' ) );
            if ($term) {
...
function venedor_meta_content_bottom() {
    ...
    if (is_category()) {
        ...
        if (function_exists('is_shop') && is_shop())  {
            $content_bottom = get_post_meta(woocommerce_get_page_id( 'shop' ), 'content_bottom', true);
        } else {
            $term = get_term_by( 'slug', get_query_var( 'term' ), get_query_var( 'taxonomy' ) );
            if ($term) {
...
function venedor_meta_hide_breadcrumbs() {
    ...
    if (is_category()) {
        ...
        if (function_exists('is_shop') && is_shop())  {
            $breadcrumbs = get_post_meta(woocommerce_get_page_id( 'shop' ), 'breadcrumbs', true);
        } else {
            $term = get_term_by( 'slug', get_query_var( 'term' ), get_query_var( 'taxonomy' ) );
            if ($term) {
...
function venedor_meta_use_default() {
    ...
    if (is_category()) {
        ...
        if (function_exists('is_shop') && is_shop())  {
            $default = get_post_meta(woocommerce_get_page_id( 'shop' ), 'default', true);
        } else {
            $term = get_term_by( 'slug', get_query_var( 'term' ), get_query_var( 'taxonomy' ) );
            if ($term) {
...
if (!is_admin() && !in_array( $GLOBALS['pagenow'], array( 'wp-login.php', 'wp-register.php' ) )) {
    ...
    wp_register_script( 'google.maps', "http".((is_ssl())?'s':'')."://maps.googleapis.com/maps/api/js?v=3.exp&amp;sensor=false&amp;language=".substr(get_locale(), 0, 2).'"', array(), null, true);
...
<?php } else if (isset($venedor_design[$field.'-bg-mode']) && $venedor_design[$field.'-bg-mode'] == 'texture' && $venedor_design[$field.'-bg-texture']) { ?>
    background-image: url(<?php echo $venedor_design[$field.'-bg-texture'] ?>);
...
<?php } else if (isset($venedor_design[$field.'-bg-mode']) && $venedor_design[$field.'-bg-mode'] == 'image' && $venedor_design[$field.'-bg-image']['url']) { ?>
    background-image: url(<?php echo $venedor_design[$field.'-bg-image']['url'] ?>);
...
<?php } else if (isset($venedor_design[$field.'-hbg-mode']) && $venedor_design[$field.'-hbg-mode'] == 'texture' && $venedor_design[$field.'-hbg-texture']) { ?>
    background-image: url(<?php echo $venedor_design[$field.'-hbg-texture'] ?>);
...
<?php } else if (isset($venedor_design[$field.'-hbg-mode']) && $venedor_design[$field.'-hbg-mode'] == 'image' && $venedor_design[$field.'-hbg-image']['url']) { ?>
    background-image: url(<?php echo $venedor_design[$field.'-hbg-image']['url'] ?>);
...
<?php } else if (isset($venedor_design[$field.'-sbg-mode']) && $venedor_design[$field.'-sbg-mode'] == 'texture' && $venedor_design[$field.'-sbg-texture']) { ?>
    background-image: url(<?php echo $venedor_design[$field.'-sbg-texture'] ?>);
    background-position: center center;
    background-repeat: repeat;
<?php } else if (isset($venedor_design[$field.'-sbg-mode']) && $venedor_design[$field.'-sbg-mode'] == 'image' && $venedor_design[$field.'-sbg-image']['url']) { ?>
    background-image: url(<?php echo $venedor_design[$field.'-sbg-image']['url'] ?>);
...
function venedor_print_shover_border($field) {
    global $venedor_design;
